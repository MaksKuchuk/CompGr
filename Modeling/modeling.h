...
class Modeling {
public:
    static Graph2DData *delayedSingleImpulse(const long long N, const long long n);

    static Graph2DData *delayedSingleHop(const long long N, const long long n);
    ...
    static Graph2DData *meander(const long long N, const long long L);

    static Graph2DData *saw(const long long N, const long long L);
